...
The methodology was also strengthened by a more structured final testing and evaluation stage. Functional testing was carried out against the core requirements of the application through the live interface, with black-box checks focused on whether major user-facing flows behaved correctly, including sound creation, parameter control, key-lock functionality, persistence, export, and public playback access. Additionally, a user evaluation was conducted with five participants, including three beginners and two experienced producers. Participants were asked to complete representative tasks, such as creating a sound, changing the shape, making a short melody, using key lock, and exporting the result, before completing a short questionnaire and giving written feedback. This combination of requirement-based functional testing and structured user evaluation was appropriate because it allowed the project to be assessed both as a technical system and as an interactive creative tool, producing evidence about correctness, usability, and creative usefulness at the same time.
