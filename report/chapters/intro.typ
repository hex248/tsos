...
Studies of contemporary music artists identify "musician's block" as a common phenomenon @nair2025musiciansblock, often linked to music-making anxiety and challenges within the creative process. As shown in @fig-top-music-production-struggles, the top self-reported struggle is not knowing "where to start". This is evermore common for beginners, who often find themselves overwhelmed by the technical complexity of music software, with a steep learning curve that requires understanding abstract concepts before engaging in creative expression. This creates friction and fatigue, leading to disengagement and frustration. Even experienced producers can get stuck in creative blocks when they use the same environment repeatedly @karanyi2023creativeblock, leading to stagnation and reduced motivation. A new way to make sounds may help a producer express themselves creatively and get out of a block.

From my own research, I found that \~66% of beginners surveyed felt that music production software seems too complicated or intimidating (see @fig-daw-complicated). This is a significant barrier to entry, and it highlights the need for more accessible tools that can help users learn and create without being overwhelmed by technical details. It is often discussed that it takes around 10,000 hours of deliberate practice to achieve mastery in a field @gladwell2008, but this can be discouraging for beginners who may not have the time or resources to invest in such a long learning process. These barriers can lead to a lack of diversity in music production, as only those with the resources and time to invest in learning complex software can participate fully. These barriers suggest a need for more intuitive, engaging, and accessible approaches to early-stage sound design that support both learning and sustained creative engagement.
